    ...
    <div class="content-box">
        ...
        <div class="comment-wrapper">
            @if(\App\IgnoreUser::i_ignore($comment->user->id))
                <div class="col-md-12 text-center padding-15">Hidden Comment</div>
            @else
                <div class="col-md-12 comment-header">
                    <div>
                        ...
                        <div class="user-nickname">
                            ...
                            <div class="user-menu">
                                <a href="{{route('user.add_friend',['id'=>$comment->user->id])}}">Add to friends</a>
                                <a href="{{route('user.messages',['id' => $comment->user->id])}}">Message</a>
                                <a href="{{route('user.set_ignore',['id'=>$comment->user->id])}}">Ignore list</a>
                            </div>
                        </div>
                        <div class="user-role">
                        ...
                        <div>
                            <a href="{{route('user.get_rating', ['id' => $comment->user->id])}}"
                               class="user-rating"> {{$comment->user->rating}} kg</a>
                        </div>
                    </div>
